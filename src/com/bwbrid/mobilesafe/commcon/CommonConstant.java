...
public class CommonConstant {
	 ...
	 * ダウンロードしたファイルの保存パス
	 */
	// public final static String DOWNLOAD_SAVE_PATH =
	// Environment.getDownloadCacheDirectory() + File.separator +
	// CommonConstant.APK_NAME;
	public final static String DOWNLOAD_SAVE_PATH = Environment
