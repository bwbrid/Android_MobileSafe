...
public class SplashActivity extends Activity {
	...
	protected void showUpdateDialog() {
		...
		// キャンセル処理
		builder.setNegativeButton(R.string.button_update_cancel, new DialogInterface.OnClickListener() {
		...
		// アップデート処理
		builder.setPositiveButton(R.string.button_update_confirm, new DialogInterface.OnClickListener() {
	...
	protected void downloadApk () {
		...
		if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
			...
			httpUtils.download(mUpdateBean.getDownloadUrl(), CommonConstant.DOWNLOAD_SAVE_PATH, new RequestCallBack<File>() {
			...
			public void run() {
    			...
    			try {
    				...
    				if (connection.getResponseCode() == CommonConstant.HTTP_SUCCESS_CODE) {
    					...
    					if (mLocalVersionCode < Integer.valueOf(mUpdateBean.getVersionCode())) {
